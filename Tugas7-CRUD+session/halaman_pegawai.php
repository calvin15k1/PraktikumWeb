...
<body style="background-image:url(img/landing.png); background-size:cover">
	<?php 
		session_start();
    ...
    <div class="container">
        <div class="rounded-lg" style="position: auto; left: 25%; right: 25%; color: white; text-align: center; background-color:slategray; opacity: 85%;">
			...
			<div class="page-header clearfix">
                ...
                <a href="halaman_pegawai.php" class="btn btn-primary pull-right">Muat Ulang</a>
            </div>
            <?php
                        ...
                        echo "<br><table align='center' class='table table-bordered table-striped' style='color: white; width: 95%;'>";
                            ...
                            while($row = mysqli_fetch_array($result)){
                                echo "<tr>";
                                    ...
                                    echo "<td>";
										echo "<a type='button' href='update.php?id=". $row['id_produk'] ."' title='Edit' data-toggle='tooltip' class='btn btn-dark btn-sm'>Edit</a>";
                                    echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
